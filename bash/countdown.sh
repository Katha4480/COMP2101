...
#### Functions
#Functions to trigger SIGQUIT and SIGINT
function foundsecret {
 stty sane
 clear
 dialog --msgbox "You found the secret of geting out of the script" 7 60
 exit
}
function reset {
 clear
 ...
 stty sane
 dialog --msgbox "You are not allowed to break the running process." 7 60
 doCountdown | dialog --gauge "Remaining Time" 7 60
 clear
 #echo "You are not allowed to break the running process."
}
...
#Transfering static value to the loop variable
sleepCount=$numberOfSleeps
